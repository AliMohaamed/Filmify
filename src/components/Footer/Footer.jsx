          ...
          <div className="container">
            <div className="row">
              <div className="col-md-4 mb-4 mb-md-0">
                ...
                <p className="mb-3">Your ultimate destination for the latest movies, reviews, and cinema news. Experience the magic of movies with us!</p>
              ...
              <div className="col-md-2 mb-4 mb-md-0">
                ...
                <ul className="list-unstyled">
                  <li className="mb-2"><a href="#" className="footer-link">Movies</a></li>
                  <li className="mb-2"><a href="#" className="footer-link">TV Shows</a></li>
                  <li className="mb-2"><a href="#" className="footer-link">Upcoming</a></li>
                  <li className="mb-2"><a href="#" className="footer-link">Trailers</a></li>
                  <li className="mb-2"><a href="#" className="footer-link">Top Rated</a></li>
                </ul>
              </div>
              ...
              <div className="col-md-4">
                ...
                <p className="mb-3">Subscribe to our newsletter for exclusive content and updates!</p>
                ...
                <p className="small">By subscribing, you agree to our Privacy Policy</p>
              </div>
            </div>
